...
class GrantSourceDefinitionToWorkspaceResponse:
    ...
    private_source_definition_read: Optional[shared_privatesourcedefinitionread.PrivateSourceDefinitionRead] = dataclasses.field(default=None)
