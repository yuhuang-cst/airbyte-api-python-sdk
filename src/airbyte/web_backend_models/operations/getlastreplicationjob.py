...
from ..shared import joboptionalread as shared_joboptionalread
...
class GetLastReplicationJobResponse:
    ...
    job_optional_read: Optional[shared_joboptionalread.JobOptionalRead] = dataclasses.field(default=None)
