...
class GrantDestinationDefinitionToWorkspaceResponse:
    ...
    private_destination_definition_read: Optional[shared_privatedestinationdefinitionread.PrivateDestinationDefinitionRead] = dataclasses.field(default=None)
